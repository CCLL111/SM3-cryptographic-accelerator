...
input	[5 : 0]				index_addr;
output	reg	[31 : 0]		tmp_for_ss1_1;

wire  [31 : 0]		data_in;
reg   [31 : 0]		data_after_shift_out;
wire  [4  : 0]      J_mod;

assign	data_in		=	index_addr < 16 ? 32'h79cc4519  : 32'h7a879d8a;
assign	J_mod		=	index_addr < 6'd32 ? index_addr	:  index_addr - 6'd32;
...
always@(posedge clk)begin
		tmp_for_ss1_1 <= data_after_shift_out;
end		
